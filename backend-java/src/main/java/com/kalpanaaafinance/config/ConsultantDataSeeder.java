...
public class ConsultantDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (profileRepository.count() == 0) {
            ...
            seedConsultant("Ananya Rao", "ananya.rao@kalpanaaafinance.com", "Investment & Wealth");
            seedConsultant("Rahul Mehta", "rahul.mehta@kalpanaaafinance.com", "Lending & Credit");
            seedConsultant("Priya Nair", "priya.nair@kalpanaaafinance.com", "Digital Finance");
            seedConsultant("Arjun Menon", "arjun.menon@kalpanaaafinance.com", "Business Finance");
