package com.kalpanaaafinance.modules.consultant.service;
...
import com.kalpanaaafinance.modules.shared.dto.ConsultantProfileRequest;
...
public class ConsultantService {
    ...
    private void seedDefaultConsultants() {
        seedSingleConsultant("Ananya Rao", "ananya.rao@kalpanaaafinance.com", "Investment & Wealth", 7, "Senior Financial Advisor specializing in portfolio diversification, SIPs, and mutual funds.");
        seedSingleConsultant("Rahul Mehta", "rahul.mehta@kalpanaaafinance.com", "Lending & Credit", 6, "Credit Specialist focusing on personal loans, mortgage restructuring, and CIBIL optimization.");
        seedSingleConsultant("Priya Nair", "priya.nair@kalpanaaafinance.com", "Digital Finance", 5, "Digital Assets and FinTech specialist providing guidance on digital wallets and electronic payments.");
        seedSingleConsultant("Arjun Menon", "arjun.menon@kalpanaaafinance.com", "Business Finance", 8, "Corporate finance & SME advisory consultant for working capital and business expansion.");
    }
