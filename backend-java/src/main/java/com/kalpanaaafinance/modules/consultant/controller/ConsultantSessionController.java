...
import com.kalpanaaafinance.modules.shared.dto.ConsultationNoteRequest;
...
public class ConsultantSessionController {
    ...
    public ResponseEntity<List<ConsultationSession>> getAll(Authentication authentication) {
        ...
        List<ConsultationAssignment> assignments = assignmentRepository.findByConsultantId(profile.getId());
