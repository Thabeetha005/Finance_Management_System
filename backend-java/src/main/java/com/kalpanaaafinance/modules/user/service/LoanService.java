...
public class LoanService {
    ...
    public Loan applyForLoan(User user, LoanApplyRequest request) {
        ...
        Loan loan = Loan.builder()
                ...
                .status(com.kalpanaaafinance.modules.shared.enums.LoanStatus.APPLICATION_SUBMITTED.name())
                .applicationStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.APPLICATION_SUBMITTED.name())
    ...
    public Loan startReview(Long adminId, Long loanId) {
        ...
        loan.setStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.UNDER_REVIEW.name());
        loan.setApplicationStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.UNDER_REVIEW.name());
    ...
    public Loan approveLoan(Long adminId, Long loanId, BigDecimal approvedAmount) {
        ...
        loan.setStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.APPROVED.name());
        loan.setApplicationStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.APPROVED.name());
    ...
    public Loan disburseLoan(Long adminId, Long loanId) {
        ...
        if (!com.kalpanaaafinance.modules.shared.enums.LoanStatus.APPROVED.name().equals(loan.getStatus()) &&
            !com.kalpanaaafinance.modules.shared.enums.LoanStatus.DISBURSED.name().equals(loan.getStatus())) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            String initialStatus = (i == 1) ? com.kalpanaaafinance.modules.shared.enums.EmiStatus.PENDING.name() : com.kalpanaaafinance.modules.shared.enums.EmiStatus.UPCOMING.name();
        ...
        loan.setStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.ACTIVE.name());
        loan.setApplicationStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.ACTIVE.name());
    ...
    public Loan requestResubmission(Long adminId, Long loanId, String reason) {
        ...
        loan.setStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.DOCUMENTS_REQUIRED.name());
        loan.setApplicationStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.DOCUMENTS_REQUIRED.name());
    ...
    public Loan rejectLoan(Long adminId, Long loanId, String reason) {
        ...
        loan.setStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.REJECTED.name());
        loan.setApplicationStatus(com.kalpanaaafinance.modules.shared.enums.LoanStatus.REJECTED.name());
        loan.setResubmissionReason(reason);
        Loan saved = loanRepository.save(loan);
