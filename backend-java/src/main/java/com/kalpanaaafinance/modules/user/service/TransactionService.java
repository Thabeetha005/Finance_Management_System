...
public class TransactionService {
    ...
    public Transaction createTransaction(Transaction transaction) {
        ...
        auditService.logAction("admin@kalpanaaafinance.com", "CREATE", "Transaction", saved.getId(), "Created transaction of type " + transaction.getType(), null);
        return saved;
    }
    
    public void deleteTransaction(Long id) {
        transactionRepository.deleteById(id);
        auditService.logAction("admin@kalpanaaafinance.com", "DELETE", "Transaction", id, "Deleted transaction", null);
    }
}
