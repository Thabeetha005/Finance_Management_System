...
import com.kalpanaaafinance.modules.user.service.WalletService;
...
public class AdminUserController {
    ...
    @Autowired
    private com.kalpanaaafinance.modules.shared.service.AuditService auditService;

    @Autowired
    private com.kalpanaaafinance.modules.user.service.WalletService walletService;

    @GetMapping("/users/{userId}/wallet-summary")
    public ResponseEntity<com.kalpanaaafinance.modules.shared.dto.WalletSummaryResponse> getUserWalletSummary(@PathVariable Long userId) {
    ...
    public ResponseEntity<?> deleteUser(
        ...
        // 3. Admin Audit Log
        String adminEmail = auth != null ? auth.getName() : "admin@kalpanaaafinance.com";
