...
public class AdminConsultantController {
    ...
    private final com.kalpanaaafinance.modules.shared.repository.UserRepository userRepository;
    ...
    public ResponseEntity<Void> deleteConsultant(
        ...
        com.kalpanaaafinance.modules.shared.entity.User admin = userRepository.findByEmail(email).orElse(null);
