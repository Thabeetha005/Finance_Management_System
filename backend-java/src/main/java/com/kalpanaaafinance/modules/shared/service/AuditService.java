...
public class AuditService {
    ...
    private void seedInitialAuditLogs() {
        logAction("admin@kalpanaaafinance.com", "SYSTEM_INITIALIZED", "SYSTEM", 1L, "Kalpanaaa Finance Core Financial Engine & Audit Trail Services Activated", "127.0.0.1");
        logAction("admin@kalpanaaafinance.com", "USER_SECURITY_AUDIT", "SECURITY", 1L, "JWT Security Policies & Role Access Control Enforced", "127.0.0.1");
        logAction("ananya.rao@kalpanaaafinance.com", "CONSULTANT_ACTIVATED", "CONSULTANT", 1L, "Consultant Profile Ananya Rao initialized & verified", "127.0.0.1");
        logAction("admin@kalpanaaafinance.com", "FINANCIAL_SYSTEM_READY", "FINANCE", 1L, "Authoritative Transaction & Statement Generation Services Enabled", "127.0.0.1");
    }
