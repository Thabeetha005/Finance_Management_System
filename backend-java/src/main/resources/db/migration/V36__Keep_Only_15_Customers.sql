-- V36__Keep_Only_15_Customers.sql
-- Retain exactly 15 customer accounts in the database, explicitly preserving CUS1021.
...
-- 3. Create temporary table of the exact 15 customer IDs to keep:
--    CUS1021 + 14 other customers
...
-- 4. Clean up related tables for customers outside the 15 kept customers
