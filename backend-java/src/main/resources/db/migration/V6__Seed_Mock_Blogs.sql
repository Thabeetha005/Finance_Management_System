...
('Kalpanaaa Finance Launches New Digital Wealth Platform', 'We are excited to announce the launch of our new digital wealth platform...', '<p>Detailed content for Kalpanaaa Finance Launches New Digital Wealth Platform goes here.</p>', 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2070&auto=format&fit=crop', '2025-05-10', (SELECT id FROM blog_categories WHERE name = 'Kalpanaaa Finance'), 'LATEST_NEWS'),
...
INSERT INTO blogs (title, excerpt, content, image_url, date, category_id, type) VALUES
('Kalpanaaa Finance Partners with Leading Fintech Platform', 'This partnership will help us deliver enhanced financial solutions...', '<p>Detailed content for Kalpanaaa Finance Partners with Leading Fintech Platform goes here.</p>', 'https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=2069&auto=format&fit=crop', '2025-05-21', (SELECT id FROM blog_categories WHERE name = 'Partnerships'), 'COMPANY_UPDATES'),
...
('Kalpanaaa Finance Annual Meet 2025 Highlights', 'A glimpse of our annual meet where we celebrated success and shared our...', '<p>Detailed content for Kalpanaaa Finance Annual Meet 2025 Highlights goes here.</p>', 'https://images.unsplash.com/photo-1515169067868-5387ec356754?q=80&w=2070&auto=format&fit=crop', '2025-05-16', (SELECT id FROM blog_categories WHERE name = 'Events'), 'COMPANY_UPDATES'),
