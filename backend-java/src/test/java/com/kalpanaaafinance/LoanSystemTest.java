...
import com.kalpanaaafinance.modules.shared.dto.LoanCalculateRequest;
import com.kalpanaaafinance.modules.shared.dto.LoanCalculateResponse;
...
public class LoanSystemTest {
    ...
    void testRateLockingAtApprovalTime() {
        Loan loan = loanService.applyForLoan(testUser, com.kalpanaaafinance.modules.shared.dto.LoanApplyRequest.builder()
